...
class SpheronApi {
    ...
    addClusterInstanceDomain(instanceId, doamin) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.sendApiRequest(HttpMethods.POST, `/v1/cluster-instance/${instanceId}/domains`, doamin);
        });
    }
    updateClusterInstanceDomain(instanceId, domainId, doamin) {
        return __awaiter(this, void 0, void 0, function* () {
            return this.sendApiRequest(HttpMethods.PATCH, `/v1/cluster-instance/${instanceId}/domains/${domainId}`, doamin);
        });
    }
